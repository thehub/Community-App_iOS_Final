...
class CompaniesViewController: ListWithSearchViewController {
    ...
    override func viewDidLoad() {
        ...
        let item2 = Company(id: "asdsad", name: "Company 2", type: "Sales", photo: "logo", logo:"companyLogo", blurb: "Lorem ipsum dolor sit amet, habitasse a suspendisse et, nec suscipit imperdiet sed, libero mollis felis egestas vivamus velit, felis velit interdum phasellus luctus, nulla molestie felis ligula diam.", locationName: "London", website: "www.dn.se", size: "10 - 50")
        let item3 = Company(id: "asdsad", name: "Compnay 3", type: "Fashion", photo: "logo", logo:"companyLogo", blurb: "Lorem ipsum dolor sit amet, habitasse a suspendisse et, nec suscipit imperdiet sed, libero mollis felis egestas vivamus velit, felis velit interdum phasellus luctus, nulla molestie felis ligula diam.", locationName: "London", website: "www.dn.se", size: "10 - 50")
        let item4 = Company(id: "asdsad", name: "Company 4", type: "Design", photo: "logo", logo:"companyLogo", blurb: "Lorem ipsum dolor sit amet, habitasse a suspendisse et, nec suscipit imperdiet sed, libero mollis felis egestas vivamus velit, felis velit interdum phasellus luctus, nulla molestie felis ligula diam.", locationName: "London", website: "www.dn.se", size: "10 - 50")
