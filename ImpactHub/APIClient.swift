...
class APIClient {
    ...
    struct SelectFields {
        ...
        static let CONTACT = "id, firstname,lastname, ProfilePic__c, Profession__c, Impact_Hub_Cities__c, User__c,Skills__c, About_Me__c,Status_Update__c,Directory_Summary__c, Interested_SDG__c,Twitter__c,Instagram__c,Facebook__c,Linked_In__c"
